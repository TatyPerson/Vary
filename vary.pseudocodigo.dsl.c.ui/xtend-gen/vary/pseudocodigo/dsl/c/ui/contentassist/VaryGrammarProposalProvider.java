...
public class VaryGrammarProposalProvider extends AbstractVaryGrammarProposalProvider {
  ...
  public HashSet<String> initializeFilteringKeywords() {
    ...
    String _string_6 = _bundle_6.getString("KEYWORD_LEER");
    ResourceBundle _bundle_7 = this.readerKeywords.getBundle();
    String _string_7 = _bundle_7.getString("KEYWORD_MIENTRAS");
    ResourceBundle _bundle_8 = this.readerKeywords.getBundle();
    String _string_8 = _bundle_8.getString("KEYWORD_REPETIR");
    ResourceBundle _bundle_9 = this.readerKeywords.getBundle();
    String _string_9 = _bundle_9.getString("KEYWORD_SEGUN_SEA");
    ResourceBundle _bundle_10 = this.readerKeywords.getBundle();
    String _string_10 = _bundle_10.getString("KEYWORD_SI");
    ResourceBundle _bundle_11 = this.readerKeywords.getBundle();
    String _string_11 = _bundle_11.getString("KEYWORD_ARCHIVO");
    ResourceBundle _bundle_12 = this.readerKeywords.getBundle();
    String _string_12 = _bundle_12.getString("KEYWORD_MATRIZ");
    ResourceBundle _bundle_13 = this.readerKeywords.getBundle();
    String _string_13 = _bundle_13.getString("KEYWORD_PROCEDIMIENTO");
    ResourceBundle _bundle_14 = this.readerKeywords.getBundle();
    String _string_14 = _bundle_14.getString("KEYWORD_FUNCION");
    ResourceBundle _bundle_15 = this.readerKeywords.getBundle();
    String _string_15 = _bundle_15.getString("KEYWORD_REGISTRO");
    ResourceBundle _bundle_16 = this.readerKeywords.getBundle();
    String _string_16 = _bundle_16.getString("KEYWORD_VECTOR");
    ResourceBundle _bundle_17 = this.readerKeywords.getBundle();
    String _string_17 = _bundle_17.getString("KEYWORD_DEVOLVER");
    HashSet<String> _newHashSet = Sets.<String>newHashSet(_string, _string_1, _string_2, _string_3, _string_4, _string_5, _string_6, _string_7, _string_8, _string_9, _string_10, _string_11, _string_12, _string_13, _string_14, _string_15, _string_16, _string_17);
