		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAlgoritmoAccess().getTipocomplejoAssignment_4_1(), "rule__Algoritmo__TipocomplejoAssignment_4_1");
					put(grammarAccess.getAlgoritmoAccess().getGlobalAssignment_5_1(), "rule__Algoritmo__GlobalAssignment_5_1");
					put(grammarAccess.getAlgoritmoAccess().getFuncionAssignment_6(), "rule__Algoritmo__FuncionAssignment_6");
					put(grammarAccess.getAlgoritmoAccess().getTieneAssignment_7(), "rule__Algoritmo__TieneAssignment_7");
					...
					put(grammarAccess.getModuloAccess().getExporta_globalAssignment_5_3_1(), "rule__Modulo__Exporta_globalAssignment_5_3_1");
					put(grammarAccess.getModuloAccess().getExporta_funcionesAssignment_5_4(), "rule__Modulo__Exporta_funcionesAssignment_5_4");
					...
					put(grammarAccess.getImplementacionAccess().getTipocomplejoAssignment_1_2_1(), "rule__Implementacion__TipocomplejoAssignment_1_2_1");
					put(grammarAccess.getImplementacionAccess().getGlobalAssignment_1_3_1(), "rule__Implementacion__GlobalAssignment_1_3_1");
					put(grammarAccess.getImplementacionAccess().getFuncionAssignment_1_4(), "rule__Implementacion__FuncionAssignment_1_4");
					put(grammarAccess.getCabeceraProcedimientoAccess().getNombreAssignment_1(), "rule__CabeceraProcedimiento__NombreAssignment_1");
					put(grammarAccess.getCabeceraProcedimientoAccess().getParametrofuncionAssignment_2_0(), "rule__CabeceraProcedimiento__ParametrofuncionAssignment_2_0");
					put(grammarAccess.getCabeceraProcedimientoAccess().getParametrofuncionAssignment_2_1_1(), "rule__CabeceraProcedimiento__ParametrofuncionAssignment_2_1_1");
					...
					put(grammarAccess.getInicioAccess().getDeclaracionAssignment_3(), "rule__Inicio__DeclaracionAssignment_3");
					put(grammarAccess.getInicioAccess().getTieneAssignment_5(), "rule__Inicio__TieneAssignment_5");
					...
					put(grammarAccess.getSegunAccess().getCasoAssignment_4(), "rule__Segun__CasoAssignment_4");
					...
					put(grammarAccess.getFuncionAccess().getParametrofuncionAssignment_3_0(), "rule__Funcion__ParametrofuncionAssignment_3_0");
					put(grammarAccess.getFuncionAccess().getParametrofuncionAssignment_3_1_1(), "rule__Funcion__ParametrofuncionAssignment_3_1_1");
					put(grammarAccess.getFuncionAccess().getDeclaracionAssignment_5_1(), "rule__Funcion__DeclaracionAssignment_5_1");
					...
					put(grammarAccess.getProcedimientoAccess().getParametrofuncionAssignment_2_0(), "rule__Procedimiento__ParametrofuncionAssignment_2_0");
					put(grammarAccess.getProcedimientoAccess().getParametrofuncionAssignment_2_1_1(), "rule__Procedimiento__ParametrofuncionAssignment_2_1_1");
					put(grammarAccess.getProcedimientoAccess().getDeclaracionAssignment_4_1(), "rule__Procedimiento__DeclaracionAssignment_4_1");
