 ...
 */
public class VaryLinesOfCodeVisitor<GRAMMAR extends Grammar> extends SquidAstVisitor<GRAMMAR> implements AstAndTokenVisitor {

  private final MetricDef metric;
  private int lastTokenLine;

  public VaryLinesOfCodeVisitor(MetricDef metric) {
    this.metric = metric;
  }
