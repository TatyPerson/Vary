...
public class DiagramapseudocodigoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DiagramapseudocodigoPackage.TIPO_SUBPROCESO: {
				TipoSubproceso tipoSubproceso = (TipoSubproceso)theEObject;
				T result = caseTipoSubproceso(tipoSubproceso);
				if (result == null) result = caseTipoComplejo(tipoSubproceso);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramapseudocodigoPackage.TIPO_FUNCION: {
				TipoFuncion tipoFuncion = (TipoFuncion)theEObject;
				T result = caseTipoFuncion(tipoFuncion);
				if (result == null) result = caseTipoSubproceso(tipoFuncion);
				if (result == null) result = caseTipoComplejo(tipoFuncion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramapseudocodigoPackage.TIPO_PROCEDIMIENTO: {
				TipoProcedimiento tipoProcedimiento = (TipoProcedimiento)theEObject;
				T result = caseTipoProcedimiento(tipoProcedimiento);
				if (result == null) result = caseTipoSubproceso(tipoProcedimiento);
				if (result == null) result = caseTipoComplejo(tipoProcedimiento);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tipo Subproceso</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tipo Subproceso</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTipoSubproceso(TipoSubproceso object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tipo Funcion</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tipo Funcion</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTipoFuncion(TipoFuncion object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tipo Procedimiento</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tipo Procedimiento</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTipoProcedimiento(TipoProcedimiento object) {
		return null;
	}
