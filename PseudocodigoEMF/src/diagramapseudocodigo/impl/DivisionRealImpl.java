 ...
 *   <li>{@link diagramapseudocodigo.impl.DivisionRealImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link diagramapseudocodigo.impl.DivisionRealImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DivisionRealImpl extends OperacionImpl implements DivisionReal {
	...
	public NotificationChain basicSetLeft(Operacion newLeft, NotificationChain msgs) {
		...
		left = newLeft;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.DIVISION_REAL__LEFT, oldLeft, newLeft);
	...
	public void setLeft(Operacion newLeft) {
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.DIVISION_REAL__LEFT, null, msgs);
			if (newLeft != null)
				msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.DIVISION_REAL__LEFT, null, msgs);
			msgs = basicSetLeft(newLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.DIVISION_REAL__LEFT, newLeft, newLeft));
	}
	...
	public NotificationChain basicSetRight(Operacion newRight, NotificationChain msgs) {
		...
		right = newRight;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.DIVISION_REAL__RIGHT, oldRight, newRight);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRight(Operacion newRight) {
		if (newRight != right) {
			NotificationChain msgs = null;
			if (right != null)
				msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.DIVISION_REAL__RIGHT, null, msgs);
			if (newRight != null)
				msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.DIVISION_REAL__RIGHT, null, msgs);
			msgs = basicSetRight(newRight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.DIVISION_REAL__RIGHT, newRight, newRight));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DiagramapseudocodigoPackage.DIVISION_REAL__LEFT:
				return basicSetLeft(null, msgs);
			case DiagramapseudocodigoPackage.DIVISION_REAL__RIGHT:
