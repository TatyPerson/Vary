 ...
 * <ul>
 *   <li>{@link diagramapseudocodigo.impl.OrImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link diagramapseudocodigo.impl.OrImpl#getRight <em>Right</em>}</li>
 *   <li>{@link diagramapseudocodigo.impl.OrImpl#getSigno_op <em>Signo op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrImpl extends operacionImpl implements Or {
	...
	protected EClass eStaticClass() {
		return DiagramapseudocodigoPackage.Literals.OR;
	}
	...
	public void setLeft(operacion newLeft) {
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.OR__LEFT, null, msgs);
			if (newLeft != null)
				msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.OR__LEFT, null, msgs);
			msgs = basicSetLeft(newLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.OR__LEFT, newLeft, newLeft));
	}
	...
	public void setRight(operacion newRight) {
		if (newRight != right) {
			NotificationChain msgs = null;
			if (right != null)
				msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.OR__RIGHT, null, msgs);
			if (newRight != null)
				msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramapseudocodigoPackage.OR__RIGHT, null, msgs);
			msgs = basicSetRight(newRight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.OR__RIGHT, newRight, newRight));
	}
	...
	public void setSigno_op(signo newSigno_op) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.OR__SIGNO_OP, oldSigno_op, signo_op));
	}
