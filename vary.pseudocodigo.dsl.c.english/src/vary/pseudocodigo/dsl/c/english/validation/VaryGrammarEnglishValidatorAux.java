...
public class VaryGrammarEnglishValidatorAux extends AbstractVaryGrammarEnglishValidator {
	...
	protected Map<String,String> registrarConstantesTipadas(List<Constantes> constantes) {
		...
		for(Constantes c: constantes) {
			if(c.getValor() instanceof NumeroEntero) {
				constantesTipadas.put(c.getVariable().getNombre(), IdiomaProyecto.getBundleLanguage().getString("keyword.entero"));
			}
				...
				constantesTipadas.put(c.getVariable().getNombre(), IdiomaProyecto.getBundleLanguage().getString("keyword.cadena"));
			}
			else if(c.getValor() instanceof Caracter) {
				constantesTipadas.put(c.getVariable().getNombre(), IdiomaProyecto.getBundleLanguage().getString("keyword.caracter"));
			}
			else if(c.getValor() instanceof ValorBooleano) {
				constantesTipadas.put(c.getVariable().getNombre(), IdiomaProyecto.getBundleLanguage().getString("keyword.logico"));
			}
		}
	...
	private String prioridadTipoOperacion(String tipo1, String tipo2) {
		String salida = "";
		if(tipo1.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.cadena"))) {
			salida = tipo1;
		}
		else if(tipo2.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.cadena"))) {
			salida = tipo2;
		}
		else if(tipo1.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero")) && tipo2.equals("real")) {
			salida = tipo1;
		}
		else if(tipo1.equals("real") && tipo2.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero"))) {
			salida = tipo2;
		}
		else if(tipo1.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.logico")) && tipo2.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero")) || tipo2.equals("real")) {
			salida = tipo2;
		}
		else if(tipo2.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.logico")) && tipo1.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero")) || tipo1.equals("real")) {
			salida = tipo1;
		}
		else if(tipo1.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.caracter")) && tipo2.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero")) || tipo2.equals("real")) {
			salida = tipo2;
		}
		else if(tipo1.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.caracter")) && tipo2.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero")) || tipo2.equals("real")) {
			salida = tipo2;
		...
		for(valor v: valores) {
			if(v instanceof Operador) {
				...
				if(op instanceof VariableID) {
					...
					tipos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.entero"));
				}
				else if(op instanceof NumeroDecimal) {
					tipos.add("real");
				}
				else if(op instanceof ValorBooleano) {
					tipos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.logico"));
				}
				else if(op instanceof ConstCadena) {
					tipos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.cadena"));
				}
				else if(op instanceof Caracter) {
					tipos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.caracter"));
				}
			}
		}
		...
		for(operacion op: operaciones) { 
			if(op instanceof Operador) {
				...
				if(o instanceof VariableID) {
					...
					tiposNativos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.entero"));
				}
					...
					nombresVariables.add("tipoNativo");
					tiposNativos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.logico"));
				}
				else if(o instanceof ConstCadena) {
					nombresVariables.add("tipoNativo");
					tiposNativos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.cadena"));
				}
				else if(o instanceof Caracter) {
					nombresVariables.add("tipoNativo");
					tiposNativos.add(IdiomaProyecto.getBundleLanguage().getString("keyword.caracter"));
				}
			}
	...
	*/
	...
	protected List<valor> buscarProblemasOperacion(String tipo, List<valor> valores) {
		...
		if(tipo.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero"))) {
			for(valor v: valores) {
		...
		else if(tipo.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.logico"))) {
			for(valor v: valores) {
		...
		else if(tipo.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.cadena"))) {
			for(valor v: valores) {
		...
		else if(tipo.equals(IdiomaProyecto.getBundleLanguage().getString("keyword.caracter"))) {
			for(valor v: valores) {
	...
	protected int asignacionOperacionVariable(List<valor> valoresProblem, Map<String,String> variables, List<String> tiposValidos) {
		int check = 1;
			for(valor v: valoresProblem) {
				if(v instanceof NumeroDecimal && tiposValidos.get(0).equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero")) && esValorSimple(v)) {
					check = 2;
				}
				else if(!(v instanceof NumeroEntero) && !(v instanceof NumeroDecimal) && tiposValidos.get(0).equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero")) && esValorSimple(v)) {
					return 3;
				}
				else if(!(v instanceof ValorBooleano) && tiposValidos.get(0).equals(IdiomaProyecto.getBundleLanguage().getString("keyword.logico")) && esValorSimple(v)) {
					return 3;
				}
				else if(!(v instanceof ConstCadena) && tiposValidos.get(0).equals(IdiomaProyecto.getBundleLanguage().getString("keyword.cadena")) && esValorSimple(v)) {
					return 3;
				}
				else if(!(v instanceof Caracter) && tiposValidos.get(0).equals(IdiomaProyecto.getBundleLanguage().getString("keyword.caracter")) && esValorSimple(v)) {
					return 3;
				}
					...
					if(tiposValidos.get(0).equals(IdiomaProyecto.getBundleLanguage().getString("keyword.entero"))) {
