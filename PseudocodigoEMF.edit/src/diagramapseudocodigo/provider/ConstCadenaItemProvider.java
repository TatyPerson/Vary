...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.ConstCadena} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstCadenaItemProvider
	 ...
	 * @generated
	 */
	public ConstCadenaItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addContenidoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstCadena_contenido_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstCadena_contenido_feature", "_UI_ConstCadena_type"),
				 DiagramapseudocodigoPackage.Literals.CONST_CADENA__CONTENIDO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConstCadena"));
	}
	...
	public String getText(Object object) {
		String label = ((ConstCadena)object).getContenido();
		return label == null || label.length() == 0 ?
			getString("_UI_ConstCadena_type") :
			getString("_UI_ConstCadena_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConstCadena.class)) {
