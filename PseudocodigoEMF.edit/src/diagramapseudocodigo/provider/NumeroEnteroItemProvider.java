...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.NumeroEntero} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumeroEnteroItemProvider
	 ...
	 * @generated
	 */
	public NumeroEnteroItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addValorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumeroEntero_valor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NumeroEntero_valor_feature", "_UI_NumeroEntero_type"),
				 DiagramapseudocodigoPackage.Literals.NUMERO_ENTERO__VALOR,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NumeroEntero"));
	}
	...
	public String getText(Object object) {
		NumeroEntero numeroEntero = (NumeroEntero)object;
		return getString("_UI_NumeroEntero_type") + " " + numeroEntero.getValor();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NumeroEntero.class)) {
