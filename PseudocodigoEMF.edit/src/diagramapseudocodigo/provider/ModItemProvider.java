...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Mod} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModItemProvider extends OperacionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mod_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mod_signo_op_feature", "_UI_Mod_type"),
				 DiagramapseudocodigoPackage.Literals.MOD__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.MOD__RIGHT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.MOD__LEFT);
		}
	...
	public String getText(Object object) {
		signo labelValue = ((Mod)object).getSigno_op();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Mod_type") :
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.MOD__RIGHT ||
			childFeature == DiagramapseudocodigoPackage.Literals.MOD__LEFT;
