...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.DivisionEntera} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DivisionEnteraItemProvider extends OperacionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DivisionEnteraItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DivisionEntera_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DivisionEntera_signo_op_feature", "_UI_DivisionEntera_type"),
				 DiagramapseudocodigoPackage.Literals.DIVISION_ENTERA__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.DIVISION_ENTERA__LEFT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.DIVISION_ENTERA__RIGHT);
		}
	...
	/**
	 * This returns DivisionEntera.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DivisionEntera"));
	}
	...
	public String getText(Object object) {
		signo labelValue = ((DivisionEntera)object).getSigno_op();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_DivisionEntera_type") :
			getString("_UI_DivisionEntera_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DivisionEntera.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.DIVISION_ENTERA__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.DIVISION_ENTERA__RIGHT,
				 DiagramapseudocodigoFactory.eINSTANCE.createLlamadaFuncion()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.DIVISION_ENTERA__LEFT ||
			childFeature == DiagramapseudocodigoPackage.Literals.DIVISION_ENTERA__RIGHT;
