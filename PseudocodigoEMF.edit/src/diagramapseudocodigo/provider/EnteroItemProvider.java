...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Entero} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnteroItemProvider extends OperadorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EnteroItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addValorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entero_valor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entero_valor_feature", "_UI_Entero_type"),
				 DiagramapseudocodigoPackage.Literals.ENTERO__VALOR,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Entero"));
	}
	...
	public String getText(Object object) {
		Entero entero = (Entero)object;
		return getString("_UI_Entero_type") + " " + entero.getValor();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entero.class)) {
