...
// 'funcion'
protected class TipoFuncion_FuncionKeyword_1 extends KeywordToken  {
	
	public TipoFuncion_FuncionKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getTipoFuncionAccess().getFuncionKeyword_1();
	}
...
protected class TipoFuncion_LeftParenthesisKeyword_2 extends KeywordToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new TipoFuncion_FuncionKeyword_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// 'procedimiento'
protected class TipoProcedimiento_ProcedimientoKeyword_0 extends KeywordToken  {
	
	public TipoProcedimiento_ProcedimientoKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getTipoProcedimientoAccess().getProcedimientoKeyword_0();
	}
...
protected class TipoProcedimiento_LeftParenthesisKeyword_1 extends KeywordToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new TipoProcedimiento_ProcedimientoKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
