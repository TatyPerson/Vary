package vary.pseudocodigo.dsl.c.validation.english.messages;
...
public class ReadMessagesValidator implements ReadMessagesValidatorInterface {
	...
	public ReadMessagesValidator() {
		resource = ResourceBundle.getBundle("vary.pseudocodigo.dsl.c.validation.english.messages.messages");
	}
