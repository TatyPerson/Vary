		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModuloAccess().getExporta_constantesAssignment_6_1(), "rule__Modulo__Exporta_constantesAssignment_6_1");
					put(grammarAccess.getModuloAccess().getExporta_tiposAssignment_7_1(), "rule__Modulo__Exporta_tiposAssignment_7_1");
					put(grammarAccess.getModuloAccess().getExporta_globalAssignment_8_1(), "rule__Modulo__Exporta_globalAssignment_8_1");
					put(grammarAccess.getModuloAccess().getExporta_funcionesAssignment_9(), "rule__Modulo__Exporta_funcionesAssignment_9");
					put(grammarAccess.getModuloAccess().getImplementacionAssignment_11(), "rule__Modulo__ImplementacionAssignment_11");
					put(grammarAccess.getImplementacionAccess().getConstantesAssignment_2_1(), "rule__Implementacion__ConstantesAssignment_2_1");
					put(grammarAccess.getImplementacionAccess().getTipocomplejoAssignment_3_1(), "rule__Implementacion__TipocomplejoAssignment_3_1");
					put(grammarAccess.getImplementacionAccess().getGlobalAssignment_4_1(), "rule__Implementacion__GlobalAssignment_4_1");
					put(grammarAccess.getImplementacionAccess().getFuncionAssignment_5(), "rule__Implementacion__FuncionAssignment_5");
